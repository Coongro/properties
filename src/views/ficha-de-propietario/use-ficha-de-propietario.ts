/**
 * Ficha de propietario — datos y estado (generado por el Builder de Vistas).
 *
...
export function useFichaDePropietarioView() {
    ...
    try {
      ...
      const data = byBlock
        ...
        : customHandlers.loadData
          ...
          : await actions.execute<any[]>('properties.unitOwners.list');
  ...
  const confirmDelete = useCallback(async () => {
    ...
    setDeleting(true);
    try {
      await actions.execute('properties.unitOwners.delete', { id: pendingDelete.id });
